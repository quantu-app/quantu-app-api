  ...
  describe "create organization" do
    test "should return created organization", %{conn: conn, user: user} do
      ...
      conn =
        post(
          conn,
          Routes.organization_path(@endpoint, :create),
          create_params
        )
  ...
  describe "update organization" do
    test "should return updated organization", %{conn: conn, user: user} do
      ...
      conn =
        put(
          conn,
          Routes.organization_path(@endpoint, :update, organization_id),
          update_params
        )
  ...
  describe "delete organization" do
    test "should delete organization", %{conn: conn, user: user} do
      ...
      delete_conn =
        delete(
          conn,
          Routes.organization_path(@endpoint, :delete, organization_id)
        )
